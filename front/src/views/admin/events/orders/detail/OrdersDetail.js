...
import { Row, Col, Button, Dropdown, Card, Table, Form } from 'react-bootstrap';
...
const OrdersDetail = () => {
  ...
  const description = 'Event Booking Detail Page';
  ...
  const sendtablebookdetail =  React.useCallback(async () => {
    document.body.classList.add('spinner');
    const response = await axios.post(`${API_URL}events/rsvp_tablebook_status_update`, { id, message });
    setTimeout(() => {
      toast.success('Event table Booking Status sent Successfully', {
        position: 'top-right',
      });
     setMessage("");
     fetchData();
                  ...
                  <Card.Body className="mb-n5">
                    <div className="mb-5">
                      <>
                        ...
                        {eventDetail.length > 0 && data.result[0].parent_cat == '2' && eventDetail[0].table_book_detail.length > 0 && (
                          <>
                            <Row className="g-0 mb-2">
                              <Col xs="auto">
                            ...
                            <Row className="g-0 mb-2">
                              <Col xs="auto">
                                ...
                                <div className="me-1">Admin New Status: 
                                <Form.Control
                                  type="text"
                              ...
                              <Col xs="auto">
                                <br/>
                                <Button variant="primary" disabled={!message}  onClick={sendtablebookdetail} type="submit">
                                Send
                              </Button></Col>
                            </Row>
                          </>
