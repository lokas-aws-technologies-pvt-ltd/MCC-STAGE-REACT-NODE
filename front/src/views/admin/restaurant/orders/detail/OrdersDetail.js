...
const OrdersDetail = () => {
  ...
  const handleRemoveFromCart = (itemId) => {
    ...
    if (choice) {
      ...
      document.body.classList.add('spinner');
      const response = axios.post(`${API_URL}restaurant/order_remove_single_item`, { itemId, itemData });
      setTimeout(() => {
        ...
        <div className="page-title-container">
          <Row className="g-0">
            ...
            <Col className="col-auto mb-3 mb-sm-0 me-auto">
              <NavLink className="muted-link pb-1 d-inline-block hidden breadcrumb-back" to="/admin/restaurant/ManageOrder">
