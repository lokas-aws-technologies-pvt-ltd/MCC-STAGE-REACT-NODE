...
const Booking = () => {
    ...
    const updateStateList = (e, id, value, courseid, limit) => {
                                ...
                                {dp == '1' &&
                                    <div>
                                        ...
                                        <div className="mb-3 mt-3">
                                            ...
                                            <Form.Select className="form-select" id="banquethall" name="banquethall" defaultValue={values.banquethall} onChange={handleChange}>
                                        ...
                                        {banquetMenus && banquetMenus.map((bx, y) => (
                                            ...
                                            <div className="col-lg-4 col-md-4 col-sm-12" key={bx.banquet_menu_id}>
                                                <div className="food-list" >
                                                    ...
                                                    <p><span>₹ {bx.banquet_menu_cost}</span> &nbsp;&nbsp;<Form.Check name="menuid" type="radio" id="menuid" value={bx.banquet_menu_id}
                                                                        ...
                                                                        <div className="item-list" key={Items.item_id}>
                                                                            ...
                                                                            <div className="form-check">
                                                                                <input type="checkbox" className="form-check-input" id={x.banquet_menu_course_id} name='itemschildval'
                                                                                    ...
                                                                                    onChange={(e) => {
                                                                                        handleChange(e);
                                                                                        updateStateList(e, Items.item_id, Items, x.banquet_menu_course_id, selectedmenu[x.menu_map_column]);
                                                                                    }} />
                            ...
                            {dp == '3' &&
                                <div>
                                    ...
                                    <div style={{ width: '50%', float: 'left' }}>
                                        <div className="mb-3 mt-3">
                                            <Form.Label htmlFor="name">Member Code :  </Form.Label>
                                            <Form.Label htmlFor="name"><b>&nbsp;&nbsp;{currentUser.membercode}</b></Form.Label></div>
                                        <div className="mb-3 mt-3">
                                            <Form.Label htmlFor="name">Member Name : </Form.Label>
                                            <Form.Label htmlFor="name"><b>&nbsp;&nbsp;{currentUser.name}</b></Form.Label></div>
                                        <div className="mb-3 mt-3">
                                            <Form.Label htmlFor="name">Number of guest :</Form.Label>
                                            <Form.Label htmlFor="name"><b>&nbsp;&nbsp;{values.noguest}</b></Form.Label></div>
                                        <div className="mb-3 mt-3">
                                            <Form.Label htmlFor="name">Date of Occassion :</Form.Label>
                                            <Form.Label htmlFor="name"><b>&nbsp;&nbsp;{values.banquetdate.toLocaleString()}</b></Form.Label></div>
                                        <div className="mb-3 mt-3">
                                            <Form.Label htmlFor="name">Hall :</Form.Label>
                                            {banquetHalls.filter(item => item.banquet_id == values.banquethall).map(filtereditem => (
                                                <Form.Label htmlFor="name" key={filtereditem.banquet_name}><b>&nbsp;&nbsp;{filtereditem.banquet_name}</b></Form.Label>
                                            ))}</div>
                                        <div className="mb-3 mt-3">
                                            <Form.Label htmlFor="name">Hours :</Form.Label>
                                            <Form.Label htmlFor="name"><b>&nbsp;&nbsp;{values.banquethour}</b></Form.Label>
                                        </div>

                                        <div className="mb-3 mt-3">
                                            <Form.Label htmlFor="name">Projector :</Form.Label>
                                            {values.Projector && values.Projector == 'Y' ? <Form.Label htmlFor="name"><b>&nbsp;&nbsp;Yes</b></Form.Label> : <Form.Label htmlFor="name"><b>&nbsp;&nbsp;No</b></Form.Label>}
                                        </div>
                                        <div className="mb-3 mt-3">
                                            <Form.Label htmlFor="name">Music System :</Form.Label>
                                            {values.music && values.music == 'Y' ? <Form.Label htmlFor="name"><b>&nbsp;&nbsp;Yes</b></Form.Label> : <Form.Label htmlFor="name"><b>&nbsp;&nbsp;No</b></Form.Label>}
                                        </div>
                                        <div className="mb-3 mt-3">
                                            <Form.Label htmlFor="name">Menu Name :</Form.Label>

                                            {banquetMenus.filter(item => item.banquet_menu_id == values.menuid).map(filtereditem => (
                                                <Form.Label htmlFor="name" key={filtereditem.banquet_menu_name}><b>&nbsp;&nbsp;{filtereditem.banquet_menu_name}</b></Form.Label>
                                            ))}
                                        </div>
                                        <div className="mb-3 mt-3">
                                            <Form.Label htmlFor="name">Fish Addon :</Form.Label>
                                            {values.fish && values.fish == true ? <Form.Label htmlFor="name"><b>&nbsp;&nbsp;Yes</b></Form.Label> : <Form.Label htmlFor="name"><b>&nbsp;&nbsp;No</b></Form.Label>}
                                        </div>
                                        <div className="mb-3 mt-3">
                                            <Form.Label htmlFor="name">Chicken Biryani :</Form.Label>
                                            {values.cbiryani && values.cbiryani == true ? <Form.Label htmlFor="name"><b>&nbsp;&nbsp;Yes</b></Form.Label> : <Form.Label htmlFor="name"><b>&nbsp;&nbsp;No</b></Form.Label>}</div>
                                        <div className="mb-3 mt-3">
                                            <Form.Label htmlFor="name">Mutton Biryani :</Form.Label>
                                            {values.mbiryani && values.mbiryani == true ? <Form.Label htmlFor="name"><b>&nbsp;&nbsp;Yes</b></Form.Label> : <Form.Label htmlFor="name"><b>&nbsp;&nbsp;No</b></Form.Label>}</div>

                                    </div>
                                    <div style={{ width: '50%', float: 'right' }}>

                                        <div className="mb-3 mt-3">
                                            <Form.Label htmlFor="name">Banquet Hall Cost :  </Form.Label>
                                            <Form.Label htmlFor="name"><b>&nbsp;&nbsp;Rs.{hallcostval}</b></Form.Label></div>
                                        <div className="mb-3 mt-3">
                                            <Form.Label htmlFor="name">Projector Cost : </Form.Label>
                                            <Form.Label htmlFor="name"><b>&nbsp;&nbsp;Rs.{projectorval}</b></Form.Label></div>
                                        <div className="mb-3 mt-3">
                                            <Form.Label htmlFor="name">Music System cost :</Form.Label>
                                            <Form.Label htmlFor="name"><b>&nbsp;&nbsp;Rs.{musicval}</b></Form.Label></div>
                                        <div className="mb-3 mt-3">
                                            <Form.Label htmlFor="name">Menu cost :</Form.Label>
                                            <Form.Label htmlFor="name"><b>&nbsp;&nbsp;Rs.{Number(selectedmenu.banquet_menu_cost) * Number(values.noguest)}</b></Form.Label></div>
                                        <div className="mb-3 mt-3">
                                            <Form.Label htmlFor="name">Fish Addon cost :</Form.Label>
                                            <Form.Label htmlFor="name"><b>&nbsp;&nbsp;Rs.{fishaddval}</b></Form.Label></div>
                                        <div className="mb-3 mt-3">
                                            <Form.Label htmlFor="name">Chicken Biryani cost :</Form.Label>
                                            {values.cbiryani && values.cbiryani == true ? <Form.Label htmlFor="name"><b>&nbsp;&nbsp;Rs.2500</b></Form.Label> : <Form.Label htmlFor="name"><b>&nbsp;&nbsp;-</b></Form.Label>}
                                        </div>
                                        <div className="mb-3 mt-3">
                                            <Form.Label htmlFor="name">Mutton Biryani cost :</Form.Label>
                                            {values.mbiryani && values.mbiryani == true ? <Form.Label htmlFor="name"><b>&nbsp;&nbsp;Rs.3350</b></Form.Label> : <Form.Label htmlFor="name"><b>&nbsp;&nbsp;-</b></Form.Label>}
                                        </div>
                                    </div>
                                    <div className="mb-3 mt-3"><Form.Label htmlFor="name">Total cost : <b>&nbsp;&nbsp;{totalcostval}</b></Form.Label></div>
