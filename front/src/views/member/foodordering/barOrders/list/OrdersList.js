...
const OrdersList = () => {
    ...
    return [
      {
        ...
        Cell: ({ row }) => {
          // console.log(row);
          return (
            <a className="list-item-heading body" href={`/member/foodordering/barOrders/detail/${row.original.order_id}`}>
  ...
  const fetchData = React.useCallback(async () => {
    ...
    const response = await axios.get(`${API_URL}bar/order_get`, { params: { CurrentUserId, term, sortBy, pageSize, pageIndex } });
          ...
          <Col>
            ...
            <div className="page-title-container">
              <NavLink className="muted-link pb-1 d-inline-block hidden breadcrumb-back" to="/member/foodordering/barHome">
                ...
                <span className="align-middle text-small ms-1">F&B Bar</span>
              </NavLink>
