...
const OrdersDetail = () => {
  const title = 'Bar Order Detail';
  const description = 'F&B Bar Order Detail Page';
  ...
  const feedback = React.useCallback(async ({ evnitem }) => {
    ...
    document.body.classList.add('spinner');
    const response = await axios.post(`${API_URL}bar/feedback`, evnitem);
    setTimeout(() => {
        ...
        <div className="page-title-container">
          <Row className="g-0">
            ...
            <Col className="col-auto mb-3 mb-sm-0 me-auto">
              <NavLink className="muted-link pb-1 d-inline-block hidden breadcrumb-back" to="/member/foodordering/barOrders/list">
