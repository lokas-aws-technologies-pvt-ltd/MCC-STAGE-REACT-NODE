...
const BookSeat = ({ eventItems, bookEvent, catData, selectedEvent, isOpenBookSeatModal, setIsOpenBookSeatModal }) => {
  ...
  const validationSchema = Yup.object().shape({
    ...
    noofdependent: Yup.string().when(['is_dependent_coming','is_dependent_attending'], {
      // is: 'Y',
      is: (is_dependent_coming, is_dependent_attending) => is_dependent_coming == 'Y' || is_dependent_attending == 'Y',
      then: Yup.string().required('No. of dependent is Required'),
    }),
    noofguest: Yup.string().when('is_guest_coming', {
      is: 'Y',
      then: Yup.string().required('No. of Guest is Required'),
    }),
    ...
    guests: Yup.array().when('is_guest_coming', {
      ...
      then: Yup.array().of(
        Yup.object().shape({
          ...
          guest_age: Yup.number().positive().max(100, 'maximum 100'),
          // .required('Age is required'),
        })
      ),
    }),
    
    veg_buffet: Yup.string().when('buffetWanted', {
      is: (buffetWanted) => buffetWanted == 'Y' && currentEvent.buffet_vprice != '0',
      then: Yup.string().required('Required')
    }),
    nonVeg_buffet: Yup.string().when(['buffetWanted'], {
      is: (buffetWanted) => buffetWanted == 'Y' && currentEvent.buffet_nvprice != '0',
      then: Yup.string().required('Required')
    }),
  ...
  const onSubmit = (values, { resetForm }) => {
    ...
    setIsGuestComing('N');
    setDependentIsAttending('N');
    setDependentIsComing('N');
    setWantBuffet('N');
    setAreYouComing('N');
    setWhoisComing('me');
  };
  ...
  useEffect(() => {
    ...
    if (parentCat == '2') {
      // if (values.is_guest_coming == 'Y' && Object.entries(values.guests).length > 0) {
        if (values.is_guest_coming == 'Y' && values.noofguest !== '') {
        // setFieldValue('guest_cost', parseInt(values.guests.length, 10) * parseInt(currentEvent.ticket_price_per_guest, 10));
        setFieldValue('guest_cost', parseInt(values.noofguest, 10) * parseInt(currentEvent.ticket_price_per_guest, 10));
    ...
    // if (values.is_dependent_coming == 'Y' && Object.entries(values.dependentMembers).length > 0) {
      if (values.is_dependent_coming == 'Y' &&  values.noofdependent !== '') {
      // setFieldValue('dependent_cost', parseInt(values.dependentMembers.length, 10) * parseInt(currentEvent.price_for_dependent, 10));
      setFieldValue('dependent_cost', parseInt(values.noofdependent, 10) * parseInt(currentEvent.price_for_dependent, 10));
    ...
    if (values.buffetWanted == 'Y') {
      ...
      const vegFoodTotal = values.veg_buffet != '' ? parseInt(values.veg_buffet, 10) * parseInt(currentEvent.buffet_vprice, 10) : 0;
      const nonVegFoodTotal = values.nonVeg_buffet != '' ? parseInt(values.nonVeg_buffet, 10) * parseInt(currentEvent.buffet_nvprice, 10) : 0;
    ...
    values.guests,
    values.veg_buffet,
    values.nonVeg_buffet, values.is_dependent_attending,values.noofguest,values.noofdependent
  ]);
          ...
          {parentCat == 2 && (
            <Container fluid>
                ...
                <>
                  ...
                  <Row>
                    ...
                    <>
                          <Col md="2">
                            ...
                            <Col md="2">
                            <Form.Control type="number" className="without_number" min="1" name="noofdependent" style={{ width: '100px' }} defaultValue={values ? values.noofdependent : selectedItem.noofdependent}  onChange={handleChange} 
                             onKeyDown={(e) => {
                              if (e.code === 'Minus') {
                                 e.preventDefault();
                                 }
                               }}/>
                            {errors.noofdependent && touched.noofdependent && (
                              <div style={{ position: 'initial', transform: 'translateZ(10px)' }} className="d-block invalid-tooltip">
                                {errors.noofdependent}
                              </div>
                            )}
                            </Col>
                  ...
                  {dependentIsComing == 'Y' && (
                    ...
                    <Row>
                      ...
                      <Col md="12">
                      <br/>
                      <Form.Label>Dependent's Details (optional) : </Form.Label>
                                    ...
                                    return (
                                      <Row key={index}>
                                        ...
                                        <Col md="2">
                                          ...
                                          <Form.Control type="number" className="without_number" name={`dependentMembers[${index}].dependent_age`} 
                                          onChange={e => {
                                            e.preventDefault();
                  ...
                  <Row>
                    ...
                    <>
                          <Col md="2">
                            ...
                            <Col md="2">
                            <Form.Control type="number" className="without_number" min="1" max={guestPerMember} name="noofguest" style={{ width: '100px' }} defaultValue={values ? values.noofguest : selectedItem.noofguest}  onChange={handleChange} 
                             onKeyDown={(e) => {
                              if (e.code === 'Minus') {
                                 e.preventDefault();
                                 }
                               }}/>
                            {errors.noofguest && touched.noofguest && (
                              <div style={{ position: 'initial', transform: 'translateZ(10px)' }} className="d-block invalid-tooltip">
                                {errors.noofguest}
                              </div>
                            )}
              ...
              {isGuestComing == 'Y' && guestPerMember > 0 ? (
                <>
                 <br/>
                 <Form.Label>Guest's Details (optional) : </Form.Label>
                <FormikProvider value={formik}>
                  <br />
                  <FieldArray
                    name="guests"
                            ...
                            return (
                              ...
                              <Row key={index}>
                                ...
                                <Col md="2">
                                  ...
                                  <Form.Control  name={`guests[${index}].guest_age`} type="number" className="without_number"
                                                        onChange={e => {
                                                          e.preventDefault();
                                                          const { value } = e.target;
                                                          const regex = /^(0*[1-9][0-9]*(\.[0-9]*)?|0*\.[0-9]*[1-9][0-9]*)$/;
                  ...
                  <Row>
                    <Col md="4">
                      ...
                      <Form.Control
                        ...
                        name="veg_buffet"
                        disabled={currentEvent.buffet_vprice == '0' ? 1 : 0}
                    ...
                    <Col md="4">
                      ...
                      <Form.Control
                        ...
                        disabled={currentEvent.buffet_nvprice == '0' ? 1 : 0}
              ...
              <Row>
                ...
                <Col md="2"> <Form.Label>Dependent Cost :</Form.Label>
                  <Form.Control type="text" name="dependent_cost" style={{ width: '100px' }} value={values ? values.dependent_cost : selectedItem.dependent_cost} readOnly /></Col>
                                                  ...
                                                  <>
                                                    ...
                                                    <Col md="1">
                                                      ...
                                                      <Form.Control
                                                        ...
                                                        type="number" className="without_number"
                                                        onChange={e => {
                                                          e.preventDefault();
                                                          const { value } = e.target;
                                                          const regex = /^(0*[1-9][0-9]*(\.[0-9]*)?|0*\.[0-9]*[1-9][0-9]*)$/;
