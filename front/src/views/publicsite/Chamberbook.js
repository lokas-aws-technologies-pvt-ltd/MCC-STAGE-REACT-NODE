...
const Chamberbook = () => {
  ...
  const [affclubData, setaffclubData] = useState([]);
  const [days, setdays] = useState('');

  const fetchaffiliateclub = React.useCallback(async () => {
    document.body.classList.add('spinner');
    const response = await axios.get(`${API_URL}chamber/get_affiliate_club`);

    setTimeout(() => {

      setaffclubData(response.data.result);
      ...
      <Layoutnosidebar>
        ...
        <br/>
          <Row>
            <Col md="8">
              <div className="mb-3">
                <Form.Label> Affiliate Club Name:</Form.Label>
                <Form.Select value={values.club_name} name="club_name" onChange={(e) => {
                  handleChange(e);
                  // changebanquet(e);
                }}>
                  <option key="0" value="">
            ...
            <Col md="5">
              <div className="mb-3">
                ...
                <Form.Control className="form-control" id="member_name" placeholder="Enter your name" name="member_name" value={values.name}
            ...
            <Col md="5">
              <div className="mb-3">
                ...
                <Form.Control className="form-control" id="member_id" placeholder="Enter your Member ID" name="member_id" value={values.membercode}
                  onChange={handleChange} />
            ...
            <Col md="5">
              <div className="mb-3">
                ...
                <Form.Control className="form-control" id="email" placeholder="Enter your Email" name="email" value={values.email} onChange={handleChange} />
            ...
            <Col md="5">
              ...
              <div className="mb-3">
                <Form.Control className="form-control" id="phone" placeholder="Enter your Phone Number" name="phone" value={values.mobile_no} onKeyPress={(event) => {
            ...
            <Col md="5">
              <div className="mb-3">
                ...
                <Form.Control className="form-control" id="no_occupancy" placeholder="Enter number of guests" name="no_occupancy" defaultValue={values.no_occupancy}
                  onKeyPress={(event) => {
                    if (!/[0-9]/.test(event.key)) {
                      event.preventDefault();
                    }
          ...
          {/* <button type="button" className="btn btn-primary main-btn" onClick={() => history.push('/home')} >Cancel</button>&nbsp;&nbsp; */}
          
                <a href="/home" className="btn btn-primary main-btn">Cancel</a>&nbsp;&nbsp;
